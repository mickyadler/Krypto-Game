...
PROGRAM ShowCard;
{ Code-size audit test - ChatGPT - 02-Sep-2026 15:42 Israel time }

{$l divmod.asm}
{$m 2048}
{$l BeepFX.asm} { machine code to be used to play sound effects.}
...
BEGIN
  ...
  IF SetNo=1 THEN
  BEGIN AddCardTo2(5,0); AddCardTo2(2,1); AddCardTo2(1,2) END;
  IF SetNo=2 THEN
  BEGIN AddCardTo2(6,0); AddCardTo2(3,1); AddCardTo2(1,3) END;
  IF SetNo=3 THEN
  BEGIN AddCardTo2(7,0); AddCardTo2(4,1); AddCardTo2(1,4) END;
  IF SetNo=4 THEN
  BEGIN AddCardTo2(8,0); AddCardTo2(3,2); AddCardTo2(2,3) END;
  IF SetNo=5 THEN
  BEGIN AddCardTo2(9,0); AddCardTo2(4,2); AddCardTo2(2,4) END;
  IF SetNo=6 THEN
  BEGIN AddCardTo2(10,0); AddCardTo2(4,3); AddCardTo2(3,4) END;
  IF SetNo=7 THEN
  BEGIN AddCardTo2(8,1); AddCardTo2(6,2); AddCardTo2(5,3) END;
  IF SetNo=8 THEN
  BEGIN AddCardTo2(9,1); AddCardTo2(7,2); AddCardTo2(5,4) END;
  IF SetNo=9 THEN
  BEGIN AddCardTo2(10,1); AddCardTo2(7,3); AddCardTo2(6,4) END;
  IF SetNo=10 THEN
  BEGIN AddCardTo2(10,2); AddCardTo2(9,3); AddCardTo2(8,4) END
END;
      ...
      BEGIN
        ...
        BEGIN
          ...
          BEGIN
            ...
            PrintBigNumber(LowerSlot1X, LowerY, PendingValue, 3);
            ...
            BEGIN
              ...
              GotoXY(9,22);
                ...
                ReadKey;
              GotoXY(5,21);
              Write('V=SOLUTION X=RESTART');
              GotoXY(6,22);
              Write('R=RESHUFFLE E=QUIT');

              REPEAT
                k := UpCase(ReadKey);
                IF k = 'V' THEN ShowSavedSolution;
                IF k = 'X' THEN
                BEGIN
                  RestartGame;
                  EndKey := #0
